...
vectorizer = pickle.load(open("/Users/sudhanshusaroj/flask/vectorizer.pkl", "rb"))
anime_similarity = pickle.load(open("/Users/sudhanshusaroj/flask/anime_similarity.pkl", "rb"))
